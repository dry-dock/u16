...
apt-get update
apt-get install -q -y git=1:2.17.0-1~ppa0~ubuntu16.04.1
...
sudo apt-get update && sudo apt-get install -q google-cloud-sdk=200.0.0
...
sudo pip install -q 'awscli==1.15.14'
...
echo "================ Adding boto3 ======================="
sudo pip install -q 'boto3==1.7.16'
