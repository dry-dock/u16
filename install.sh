...
echo "================= Adding doctl.7.2 ============"
curl -OL https://github.com/digitalocean/doctl/releases/download/v1.7.2/doctl.7.2-linux-amd64.tar.gz
tar xf doctl.7.2-linux-amd64.tar.gz
sudo mv ~/doctl /usr/local/bin
rm doctl.7.2-linux-amd64.tar.gz
