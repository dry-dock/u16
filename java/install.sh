...
wget "http://download.oracle.com/otn-pub/java/jdk/"$ORACLEJDK_VERSION"+28/55eed80b163941c8885ad9298e6d786a/jdk-"$ORACLEJDK_VERSION"_linux-x64_bin.tar.gz"
tar -xzf openjdk-"$ORACLEJDK_VERSION"_linux-x64_bin.tar.gz
